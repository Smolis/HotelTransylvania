 ...
 */
public class JFrameCerrarReservaImp extends JFrameCerrarReserva {
	 ...
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	private static final long serialVersionUID = -1018483805553855342L;
	...
	public void initGUI() {
		// begin-user-code
		framePrinc = new JFrame("Cerrar reserva");
	...
	public void initLateralPanel() {
		...
		cerrarReserva.setEnabled(false);
	...
	public void initCentralPanel() {
		...
		JLabel id = new JLabel("  Introduce el ID de la reserva a cerrar: ");
